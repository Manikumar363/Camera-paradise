          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {recentInquiries.map((message) => (
                    <Link key={message.id} href="/messages">
                      <div
                        className={`flex items-start gap-4 cursor-pointer hover:bg-gray-50 p-2 rounded-md ${
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <BarChart3 className="h-5 w-5" /> Listing Performance
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64 flex items-center justify-center text-gray-500">
                  Listing performance chart (e.g., views, bookings over time) would be displayed here.
                </div>
              </CardContent>
            </Card>
          </TabsContent>
